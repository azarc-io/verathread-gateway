module github.com/azarc-io/verathread-gateway
...
require (
	...
	github.com/azarc-io/verathread-next-common v1.0.1-beta.22
...
//replace github.com/wundergraph/graphql-go-tools/execution => /Users/waeljammal/Development/graphql-go-tools/execution
